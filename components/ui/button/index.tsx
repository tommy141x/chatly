...
const buttonStyle = tva({
  base: "group/button rounded bg-primary-500 flex-row items-center justify-center data-[focus-visible=true]:web:outline-none data-[focus-visible=true]:web:ring-2 data-[disabled=true]:opacity-40 duration-300",
  variants: {
    action: {
      primary:
        "bg-primary-500 data-[hover=true]:bg-primary-950 data-[active=true]:bg-primary-700 border-primary-300 data-[hover=true]:border-primary-400 data-[active=true]:border-primary-500 data-[focus-visible=true]:web:ring-indicator-info ",
      secondary:
      ...
      default:
        "bg-transparent data-[hover=true]:bg-background-100 data-[active=true]:bg-transparent",
    },
    variant: {
      link: "px-0",
      outline:
        "bg-transparent border data-[hover=true]:bg-background-100 data-[active=true]:bg-transparent",
      solid: "",
    },
